  ...
  const features = [
    {
      ...
      category: 'ai_ats',
      icon: Sparkles,
      iconBg: 'bg-orange-50 text-[#FF4D2D]',
      badgeAr: 'مدعوم بـ Gemini AI',
      badgeEn: 'Gemini AI Powered',
      badgeColor: 'bg-orange-50 text-[#FF4D2D] border-orange-200',
    ...
    },
    {
      ...
      badgeAr: 'هيكل قياسي متوافق مع ATS',
      badgeEn: 'ATS-Friendly Structure',
      badgeColor: 'bg-emerald-50 text-emerald-900 border-emerald-200',
      titleAr: 'قوالب مهندسة لتسهيل الفرز الآلي',
      titleEn: 'Engineered ATS-Friendly Templates',
    ...
    },
    {
      ...
      icon: ShieldCheck,
      iconBg: 'bg-slate-100 text-[#001639]',
      badgeAr: 'أمان وتشفير محلي 100%',
      badgeEn: '100% Client Privacy',
      badgeColor: 'bg-slate-50 text-[#001639] border-slate-200',
