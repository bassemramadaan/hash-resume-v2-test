...
export const HowItWorksSection: React.FC<HowItWorksSectionProps> = ({ isAr }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: FormInput,
      descAr: 'اتبع النموذج المنظم لإدخال البيانات الشخصية، الخبرات، والمهارات، أو استورد سيرتك الذاتية السابقة مباشرة.',
      descEn: 'Follow the 9 guided steps to enter your details, or import your existing CV in one click.',
