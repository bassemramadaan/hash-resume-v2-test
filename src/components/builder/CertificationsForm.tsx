  ...
  return (
    <div className="space-y-6 text-slate-800" aria-live="polite">
      ...
      >
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-[#001639] hover:bg-[#00245E] text-white font-semibold rounded-lg text-xs transition flex items-center justify-center gap-1.5 cursor-pointer min-h-[36px]"
        >
