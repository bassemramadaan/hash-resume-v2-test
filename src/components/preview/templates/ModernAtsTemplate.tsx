...
export const ModernAtsTemplate: React.FC<TemplateProps> = React.memo(({ data, settings }) => {
  ...
  return (
    <div
      className="resume-template-container w-[210mm] min-h-[297mm] bg-white text-gray-900 p-8 shadow-sm transition-all duration-200 text-sm leading-relaxed text-start"
      dir={docDir}
