...
export const translations = {
  ar: {
    ...
    planSingleTitle: "تفعيل واحد + توصيل للشركات",
    planSinglePrice: "50 ج.م",
    planSingleDesc: "تشمل تصميم سيرة ذاتية PDF متوافقة 100% مع ATS + الرفع والربط التلقائي على منصة Hash Hunt لتوصيلك بالشركات المتعاقدة معنا.",
    planSingleFeature1: "تحميل السيرة الذاتية بصيغة PDF عالية الجودة متوافقة مع ATS",
    planSingleFeature2: "الرفع والتكشيف التلقائي على Hash Hunt لتوصيلك بشركات التوظيف",
    planSingleFeature3: "جميع القوالب المحترفة واستخدام الذكاء الاصطناعي لتحسين الصياغة",
    planSingleFeature4: "حفظ تلقائي في المتصفح بخصوصية 100% بدون اشتراكات شهري",

    planBundleTitle: "باقة 3 تفعيلات + فرصة توظيف",
    planBundleBadge: "الأكثر توفيراً (120 ج.م بدل 150)",
    planBundlePrice: "120 ج.م",
    planBundleDesc: "3 سير ذاتية متوافقة مع ATS مع رفعها وتوصيلها جميعاً للشركات المتعاقدة عبر Hash Hunt.",
    planBundleFeature1: "3 تفعيلات مستقلة لإنشاء 3 سير ذاتية مختلفة بأسماء أو تخصصات متعددة",
    planBundleFeature2: "ربط ورفع السير الذاتية تلقائياً على Hash Hunt لتسويقك لدى الشركات",
    planBundleFeature3: "توفير 30 جنيه مصري فوراً مقارنةً بالتحميل الفردي",
    planBundleFeature4: "تحليل ATS غير محدود ودعم فني أولوية عبر واتساب",
  ...
  en: {
    ...
    planSingleTitle: "Single Activation + Job Referral",
    planSinglePrice: "50 EGP",
    planSingleDesc: "Includes 1 high-resolution ATS PDF download PLUS automated upload & referral on Hash Hunt connecting your CV directly with contracted companies.",
    planSingleFeature1: "1 High-resolution ATS-compliant PDF export",
    planSingleFeature2: "Automated upload & referral to contracted hiring partners via Hash Hunt",
    planSingleFeature3: "All 5 professional templates & AI bullet optimizer",
    planSingleFeature4: "100% private client-side browser storage (no subscriptions)",

    planBundleTitle: "3-Resume Pack + Career Placement",
    planBundleBadge: "Best Value (120 EGP - Save 30 EGP)",
    planBundlePrice: "120 EGP",
    planBundleDesc: "3 separate ATS resumes with automated indexing on Hash Hunt to connect all your CV variations with hiring companies.",
    planBundleFeature1: "3 separate activation slots for targeted resume variations",
    planBundleFeature2: "Automated indexing & company referral on Hash Hunt for all copies",
    planBundleFeature3: "Save 30 EGP instantly compared to single purchases",
    planBundleFeature4: "Unlimited AI ATS Analyzer & VIP WhatsApp support",
